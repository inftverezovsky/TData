  ...
  if (getKhlMatchReadiness(match) === "IDENTITY_WARNING") {
    return {
      ...
      warning: {
        ...
        description: "Счёт и статистика доступны для итогов соответствующего игрового дня. Все игроки сохранены; игроки без ID не объединяются между матчами. Активация и staging заблокированы до подтверждения идентичности.",

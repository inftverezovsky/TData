...
import { normalizeTableTennisCategoryScope } from "@backend/sources/tablet/config";
import { selectCachedWttCategoryTournament } from "@backend/sources/tablet/wttCategorySwitchCache";
...
export async function POST(
  ...
  try {
    ...
    logApiError("api:[disciplineSlug]/tournament/[id]/wtt-category-switch/route.ts", error);

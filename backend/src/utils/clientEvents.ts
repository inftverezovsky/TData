export const TOURNAMENT_DATA_UPDATED_EVENT = "tdata:tournament-data-updated";
export const TEAM_MAPPINGS_UPDATED_EVENT = "tdata:team-mappings-updated";
export const ADMIN_MAPPING_UPDATED_EVENT = "tdata:admin-mapping-updated";
